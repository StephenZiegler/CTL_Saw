...
typedef struct {
  ...
  UINT64 lPosition;                 //Present position in units of 1/65536 counts
  INT64 lVelocity;                  //Present velocity in units of TRAJECTORY_FREQ/65536 counts per second
  UINT32 nDestination;              //Target destination in units of counts
  UINT32 nMaxVelocity;              //Maximum velocity in counts per second
  UINT32 nAcceleration;             //Acceleration to apply at start of move,
                                    //in units of TRAJECTORY_FREQ^2/65536 counts per sec^2
  UINT32 nDeceleration;             //Deceleration to apply at end of move,
                                    //in units of TRAJECTORY_FREQ^2/65536 counts per sec^2
}tTRAJECTORY;
...
void TrajectoryInit(tTRAJECTORY* pTrajectory,
                    UINT32 nMaxVelocity,
                    UINT32 nAcceleration,
                    UINT32 nDeceleration);
...
UINT32 TrajectoryUpdate(tTRAJECTORY* pTrajectory);
